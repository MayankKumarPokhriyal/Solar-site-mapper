...
import { fetchSolarResource } from "../services/nrelSolar.service.js";

/**
 * GET /api/solar?lat=&lon=
 * Returns normalized annual solar resource fields from NREL.
 */
export async function getSolar(req, res) {
  try {
    ...
    const data = await fetchSolarResource(apiKey, parsed.lat, parsed.lon);
